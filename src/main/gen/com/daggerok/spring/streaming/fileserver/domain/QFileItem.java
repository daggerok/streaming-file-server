...
public class QFileItem extends EntityPathBase<FileItem> {
    ...
    private static final long serialVersionUID = -1787123684L;

    public static final QFileItem fileItem = new QFileItem("fileItem");

    public final com.daggerok.spring.streaming.fileserver.domain.audit.QAbstractAuditEntity _super = new com.daggerok.spring.streaming.fileserver.domain.audit.QAbstractAuditEntity(this);
