...
=== postgres database
include::./includes/install/postgres-in-docker.adoc

=== in-memory h2 database
include::./includes/install/in-mempry-h2.adoc

=== take advantages of spring-boot executable jar
include::./includes/run/executable-jar.adoc

=== simplicity bootstrap with automation shell-script

==== unix (bash)
include::./includes/run/unix.adoc

==== windows (batch cmd)
include::./includes/run/windows.adoc
