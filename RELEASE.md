...
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/docker-compose.yml
docker-compose up -d

# file-items data service
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/file-items-service-4.3.23.jar
java -jar file-items-service-4.3.23.jar --spring.profiles.active=db-pg

# file server
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/file-server-4.3.23.jar
java -jar file-server-4.3.23.jar --app.upload.path=./path/to/file-storage
...
```bash
# bash script
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/application.bash
...
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/application.cmd
...
bash file-items-service-4.3.23.jar --spring.profiles.active=db-h2
bash file-server-4.3.23.jar --app.upload.path=./path/to/file-storage
```
...
```bash
# bash shell script
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/application-h2.bash
...
```cmd
@rem cmd script
wget https://github.com/daggerok/streaming-file-server/releases/download/4.3.23/application-h2.cmd
