...
bash file-items-service-4.3.12.jar --spring.profiles.active=db-pg
...
**for windows use https://github.com/daggerok/streaming-file-server/releases/download/4.3.12/application.cmd**
...
# bash file-items-service-4.3.12.jar --spring.profiles.active=db-h2 # or just:
...
**for windows use https://github.com/daggerok/streaming-file-server/releases/download/4.3.12/application-h2.cmd**
