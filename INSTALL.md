...
bash file-items-service-4.3.39.jar --spring.profiles.active=db-pg
...
**for windows use https://github.com/daggerok/streaming-file-server/releases/download/4.3.39/application.cmd**
...
# bash file-items-service-4.3.39.jar --spring.profiles.active=db-h2 # or just:
bash file-items-service-4.3.39.jar
bash file-server-4.3.39.jar --app.upload.path=./path/to/file-storage
```
...
**for windows use https://github.com/daggerok/streaming-file-server/releases/download/4.3.39/application-h2.cmd**
