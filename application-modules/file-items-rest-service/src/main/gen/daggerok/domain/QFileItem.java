...
public class QFileItem extends EntityPathBase<FileItem> {
    ...
    private static final long serialVersionUID = 948892081L;

    public static final QFileItem fileItem = new QFileItem("fileItem");

    public final daggerok.domain.audit.QAbstractAuditEntity _super = new daggerok.domain.audit.QAbstractAuditEntity(this);
