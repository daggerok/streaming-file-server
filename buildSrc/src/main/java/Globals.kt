...
object Globals {
  ...
  const val selenideVersion = "5.2.8"
  ...
  const val fontAwesomeVersion = "5.10.1"
  const val powermockitoVersion = "2.0.2"
  const val springBootVersion = "2.2.0.M5"
  const val bootstrapFileInputVersion = "5.0.1"
  const val hibernateJava8Version = "5.4.4.Final"
